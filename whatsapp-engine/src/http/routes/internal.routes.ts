...
import { InternalSessionController } from "../controllers/internal-session.controller.js";
import { EventBus } from "../../infra/redis/event-bus.js";

async function internalAuth(req: FastifyRequest, reply: FastifyReply): Promise<void> {
...
export async function registerInternalRoutes(
  app: FastifyInstance,
  controller: InternalSessionController,
  bus: EventBus
): Promise<void> {
